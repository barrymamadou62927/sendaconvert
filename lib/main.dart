      ...
      body: SafeArea(child: Column(children: [
        ...
        Padding(
          ...
          child: Align(
            ...
            child: Text(_expression, style: const TextStyle(color: Color(0xFFF0F0F0), fontSize: 32, fontWeight: FontWeight.w300)),
          ),
        ),
        Padding(
                ...
                return Expanded(child: Padding(
                  ...
                  child: GestureDetector(
                    ...
                    child: Container(
                      height: 64,
                      decoration: BoxDecoration(
                        color: isOp ? const Color(0xFFF5A623) : isFunc ? const Color(0xFF1A1A1E) : const Color(0xFF242428),
                        borderRadius: BorderRadius.circular(14),
                      ),
